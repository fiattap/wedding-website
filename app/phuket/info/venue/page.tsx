      ...
      <div className="grid gap-8 md:grid-cols-2 md:gap-14">
        ...
        <div className="flex items-center">
          <p className="max-w-md text-[16px] leading-8 text-[#6e655e]">
            Our morning ceremony will take place in a serene tropical setting by
            the sea, surrounded by lush greenery and the soft rhythm of Phuket.
          </p>
        </div>
      </div>
    </FadeSection>
    ...
    <FadeSection>
      <div className="grid gap-8 md:grid-cols-2 md:gap-14">
        <div>
          ...
          <h2 className="text-[30px] font-light leading-tight md:text-[44px]">
            Beach Lawn at Thavorn
          </h2>
        </div>

        <div className="flex items-center">
          <p className="max-w-md text-[16px] leading-8 text-[#6e655e]">
            As the sun sets, we’ll gather for dinner and celebration in a warm,
            romantic setting overlooking the water.
          </p>
        </div>
      </div>
    </FadeSection>
